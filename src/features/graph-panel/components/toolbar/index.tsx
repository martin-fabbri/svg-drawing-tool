...
type PropsWithContext = IProps & IGraphPanelContext;

class Index extends React.PureComponent<IProps> {
  public render() {
    const { activeTool, onToolSelected } = this.props as PropsWithContext;
    return (
      <Container className="bp3-dark">
        <ToolbarGroup align={Alignment.LEFT}>
          <ButtonGroup className="bp3-dark">
            <ToolbarOption
              id={GraphPanelTools.Selection}
...
export default withGraphPanelContext(Index);
