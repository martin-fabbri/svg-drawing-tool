...
const ellipseIcon = iconWrapper(
  <g data-name="Layer 2">
    <g data-name="Layer 1">
      <path
        d="M9.881 14.308c-2.718 0-5.705-2.068-7.117-4.93-1.651-3.33-.63-6.768 2.222-7.507a3.513 2.546 0 0 1 1.186-.142c2.703 0 5.706 2.067 7.117 4.93a12.011 8.705 0 0 1 .526 4.885 4.73 3.428 0 0 1-2.763 2.622 3.423 2.48 0 0 1-1.171.142z"
        fillOpacity="0"
      />
...
const polyIcon = iconWrapper(
  <g data-name="Layer 2">
    <path
      style={{ stroke: "#bfccd6" }}
      fillOpacity="0"
      d="M.6 9.56c-.14-1.09.87-7.8 1-8.84a.16.16 0 0 1 .19-.14h10.13L7.28 5.14l5.3 5.71L.75 9.7a.15.15 0 0 1-.15-.14z"
      strokeWidth="1.17"
      strokeLinecap="round"
      strokeLinejoin="round"
      transform="matrix(1.06 0 0 1.21494 1.046 1.042)"
      data-name="Layer 1"
    />
  </g>,
);
  ...
  <g id="Layer_2" data-name="Layer 2" transform="matrix(.99152 0 0 .95407 .99 1.002)">
    <g id="Layer_1-2" data-name="Layer 1">
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M8.57.67L6.8 7.42 8.57 14"
      />
      <path
        style={{ stroke: "#bfccd6" }}
        d="M.67 10.75C1 10.68 6.8 7.42 6.8 7.42l6.64 1.67"
        fill="none"
        strokeWidth="1.33"
        strokeLinecap="round"
        strokeLinejoin="round"
