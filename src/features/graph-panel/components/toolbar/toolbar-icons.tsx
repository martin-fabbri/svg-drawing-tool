...
const squareIcon = iconWrapper(
    <g data-name="Layer 2">
        <g data-name="Layer 1">
            <path fillOpacity="0" d="M.805 2.946h14.402v10.122H.805z"/>
...
const quadIcon = iconWrapper(
    <g data-name="Layer 2" transform="matrix(.95526 -.00427 0 .93332 .993 1.335)">
        <g data-name="Layer 1">
            <path style={{stroke: "#bfccd6"}} strokeWidth="1.33" strokeLinecap="round" strokeLinejoin="round" d="M4.71.67V14"/>
            <path style={{stroke: "#bfccd6"}} strokeWidth="1.33" strokeLinecap="round" strokeLinejoin="round" d="M.67 9.65H14"/>
        </g>
    </g>
);
...
const ellipseIcon = iconWrapper(
    <g data-name="Layer 2">
        <g data-name="Layer 1">
            <path d="M9.881 14.308c-2.718 0-5.705-2.068-7.117-4.93-1.651-3.33-.63-6.768 2.222-7.507a3.513 2.546 0 0 1 1.186-.142c2.703 0 5.706 2.067 7.117 4.93a12.011 8.705 0 0 1 .526 4.885 4.73 3.428 0 0 1-2.763 2.622 3.423 2.48 0 0 1-1.171.142z" fillOpacity="0" />
...
const polyIcon = iconWrapper(
    <g data-name="Layer 2">
        <path style={{stroke: "#bfccd6"}} fillOpacity="0" d="M.6 9.56c-.14-1.09.87-7.8 1-8.84a.16.16 0 0 1 .19-.14h10.13L7.28 5.14l5.3 5.71L.75 9.7a.15.15 0 0 1-.15-.14z" strokeWidth="1.17" strokeLinecap="round" strokeLinejoin="round" transform="matrix(1.06 0 0 1.21494 1.046 1.042)" data-name="Layer 1"/>
    </g>
);
    ...
    <g id="Layer_2" data-name="Layer 2" transform="matrix(.91824 0 0 1.2381 1.073 1.022)">
        <g id="Layer_1-2" data-name="Layer 1">
            <path
                ...
                id="path4154" style={{stroke: "#bfccd6"}} fillOpacity="0" strokeLinecap="round" strokeLinejoin="round"/>
            <circle className="cls-2" cx="3.56" cy="7.05" r="1.33" id="circle4156" style={{stroke: "#bfccd6"}} fillOpacity="0"
                    strokeWidth=".67" strokeLinecap="round" strokeLinejoin="round"/>
            <path className="cls-2"
                  d="M6.86 8.23c-1.18-1.3 1.31-5.81 3.49-5.86a3 3 0 0 1 2.94 3.25C12.8 7.52 8 9.43 6.86 8.23z"
                  id="path4158" style={{stroke: "#bfccd6"}} fillOpacity="0" strokeWidth=".67" strokeLinecap="round"
...
const curlyGateIcon = iconWrapper(
    <g id="Layer_2" data-name="Layer 2" transform="translate(0 1.33)">
        <g id="Layer_1-2" data-name="Layer 1" transform="matrix(.97346 0 0 .95578 .999 -.303)">
            ...
            <path style={{stroke: "#bfccd6"}} d="M.67 9.82s8 1.81 13-4" id="path67" fill="none" strokeWidth="1.33"
...
const spiderGateIcon = iconWrapper(
    <g id="Layer_2" data-name="Layer 2" transform="matrix(.99152 0 0 .95407 .99 1.002)">
        <g id="Layer_1-2" data-name="Layer 1">
            <path style={{stroke: "#bfccd6"}} fill="none" strokeWidth="1.33"
                  strokeLinecap="round" strokeLinejoin="round" d="M8.57.67L6.8 7.42 8.57 14"/>
...
export default {pointerIcon, squareIcon, quadIcon, ellipseIcon, polyIcon, autoGateIcon, curlyGateIcon, spiderGateIcon}